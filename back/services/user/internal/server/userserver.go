...
func (s *UserServer) CreateRechargeOrder(ctx context.Context, in *user.CreateRechargeOrderRequest) (*user.CreateRechargeOrderResponse, error) {
	l := logic.NewCreateRechargeOrderLogic(ctx, s.svcCtx)
	return l.CreateRechargeOrder(in)
}

func (s *UserServer) UpdateRechargeOrderStatus(ctx context.Context, in *user.UpdateRechargeOrderStatusRequest) (*user.UpdateRechargeOrderStatusResponse, error) {
	l := logic.NewUpdateRechargeOrderStatusLogic(ctx, s.svcCtx)
