...
type OrderInfo struct {
	...
	GameMode        string                 `protobuf:"bytes,6,opt,name=game_mode,json=gameMode,proto3" json:"game_mode,omitempty"`                       // 模式/段位等补充信息（可选）
	DurationMinutes int32                  `protobuf:"varint,7,opt,name=duration_minutes,json=durationMinutes,proto3" json:"duration_minutes,omitempty"` // 服务时长（分钟）
	PricePerHour    int64                  `protobuf:"varint,8,opt,name=price_per_hour,json=pricePerHour,proto3" json:"price_per_hour,omitempty"`        // 单价（每小时帅币）
	TotalAmount     int64                  `protobuf:"varint,9,opt,name=total_amount,json=totalAmount,proto3" json:"total_amount,omitempty"`             // 订单总价（帅币）
	Status          int32                  `protobuf:"varint,10,opt,name=status,proto3" json:"status,omitempty"`                                         // 订单状态（见上方状态说明）
	// 时间相关（时间戳，单位：秒）
	CreatedAt   int64 `protobuf:"varint,11,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	PaidAt      int64 `protobuf:"varint,12,opt,name=paid_at,json=paidAt,proto3" json:"paid_at,omitempty"`
	AcceptedAt  int64 `protobuf:"varint,13,opt,name=accepted_at,json=acceptedAt,proto3" json:"accepted_at,omitempty"`
	...
	CancelledAt int64 `protobuf:"varint,16,opt,name=cancelled_at,json=cancelledAt,proto3" json:"cancelled_at,omitempty"`
	// 评价相关
	Rating  float64 `protobuf:"fixed64,17,opt,name=rating,proto3" json:"rating,omitempty"` // 老板对陪玩的评分（0-5）
	Comment string  `protobuf:"bytes,18,opt,name=comment,proto3" json:"comment,omitempty"` // 评价内容
	// 取消相关
	CancelReason  string `protobuf:"bytes,19,opt,name=cancel_reason,json=cancelReason,proto3" json:"cancel_reason,omitempty"` // 取消原因
...
func (x *OrderInfo) GetGameMode() string {
	if x != nil {
		return x.GameMode
	}
	return ""
...
type CreateOrderRequest struct {
	...
	GameMode        string                 `protobuf:"bytes,4,opt,name=game_mode,json=gameMode,proto3" json:"game_mode,omitempty"`                       // 模式/段位等补充信息（可选）
	DurationMinutes int32                  `protobuf:"varint,5,opt,name=duration_minutes,json=durationMinutes,proto3" json:"duration_minutes,omitempty"` // 服务时长（分钟）
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *CreateOrderRequest) GetGameMode() string {
	if x != nil {
		return x.GameMode
	}
	return ""
...
const file_order_proto_rawDesc = "" +
	"\n" +
	"\vorder.proto\x12\x05order\"\xc9\x04\n" +
	"\tOrderInfo\x12\x0e\n" +
	...
	"\tgame_name\x18\x05 \x01(\tR\bgameName\x12\x1b\n" +
	"\tgame_mode\x18\x06 \x01(\tR\bgameMode\x12)\n" +
	"\x10duration_minutes\x18\a \x01(\x05R\x0fdurationMinutes\x12$\n" +
	"\x0eprice_per_hour\x18\b \x01(\x03R\fpricePerHour\x12!\n" +
	"\ftotal_amount\x18\t \x01(\x03R\vtotalAmount\x12\x16\n" +
	"\x06status\x18\n" +
	" \x01(\x05R\x06status\x12\x1d\n" +
	"\n" +
	"created_at\x18\v \x01(\x03R\tcreatedAt\x12\x17\n" +
	"\apaid_at\x18\f \x01(\x03R\x06paidAt\x12\x1f\n" +
	"\vaccepted_at\x18\r \x01(\x03R\n" +
	"acceptedAt\x12\x19\n" +
	"\bstart_at\x18\x0e \x01(\x03R\astartAt\x12!\n" +
	"\fcompleted_at\x18\x0f \x01(\x03R\vcompletedAt\x12!\n" +
	"\fcancelled_at\x18\x10 \x01(\x03R\vcancelledAt\x12\x16\n" +
	"\x06rating\x18\x11 \x01(\x01R\x06rating\x12\x18\n" +
	"\acomment\x18\x12 \x01(\tR\acomment\x12#\n" +
	"\rcancel_reason\x18\x13 \x01(\tR\fcancelReason\"\xb5\x01\n" +
	...
	"\tgame_mode\x18\x04 \x01(\tR\bgameMode\x12)\n" +
