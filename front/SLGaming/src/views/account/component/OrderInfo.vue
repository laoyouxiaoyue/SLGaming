...
<template>
  <div class="setting-info">
    ...
    <div class="setting-content">
      <!-- 只有角色为 2 (既可以下单也可以接单) 时显示身份切换 -->
      <el-tabs v-if="roleTabsVisible" v-model="activeRole" class="role-tabs">
        <el-tab-pane label="我的下单" name="boss" />
        <el-tab-pane label="陪玩订单" name="companion" />
      </el-tabs>
        ...
        <div v-else class="order-list">
          <el-card v-for="item in orders" :key="item.id" shadow="hover" class="order-card">
            ...
            <div class="card-footer">
              ...
              <!-- 陪玩视角 (接单方) -->
              <template v-if="activeRole === 'companion'">
                <el-button
                  v-if="item.status === 2"
                  type="primary"
                  size="small"
